...
| ----- | ----- | ----- |
| Tile Index Overlay | Creates a new layer with the tile index number in the upper left corner | [Readme](https://github.com/Pixeltica/AsepriteExtensions/tree/main/TileIndexOverlay) |
